<title>Leerjaar 2 | Kwadratische verbanden (2 vmbo-t)</title>
...
<div class="tekstblok opdracht analyse">
	...
	<ol>
		<li>
			...
			<li>
				Er is een figuur met `27` blokjes. Bereken met de twee pijlenkettingen welk nummer figuur dit is.
			</li>  
		</ol>
			...
			<div class="antwoord">
				<h3>Antwoorden bij opdracht 1</h3>
					<ol>
						...
						<li>
							<em>aantal blokjes</em> `= 1 + 2 *` <em>nummer figuur</em><br>
							<em>aantal blokjes</em> `= 1 + 2 * 9`<br>
							<em>aantal blokjes</em> `= 1 + 18` <br>
							<em>aantal blokjes</em> `= 19`
						</li>
						<li><br>
							<img src="afbeeldingen/analyse_kwadratische_verbanden_vmbo-t/antwoord_opdracht_1g"   width="300px">
						</li>
	...
	<ol>
		...
		<li>
			...
			<TABLE FRAME="void" RULES="all"  width="500px" style= "text-align: center">
					...
					<TR>
						<TD width="150px"><em>Kosten</em></TD><TD></TD><TD></TD>
					</TR>
				</TABLE><br>
		</li>
		<li>
			Teken de grafiek van de <em>Kosten</em>. Gebruik daarvoor de tabel.
		</li>
		<li>
...
<div class="hider">
		...
		<li><br>
			<img src="afbeeldingen/analyse_kwadratische_verbanden_vmbo-t/antwoord_kosten_bellen_f"  width="500" />
			Ik heb dus `35` minuten gebeld.
		</li>
</div>
...
<div class="tekstblok opdracht">
	...
	<p>
		...
		<em>Beltegoed</em> `= 40 - 0,25 * `aantal minuten.
	</p>
	<ol>
		<li>
		...
		<li>
			...
			<TABLE FRAME="void" RULES="all"  width="500px" style= "text-align: center">
					<TR>
						<TD width="150px"><em>aantal minuten</em></TD><TD>0</TD><TD>40</TD>
					</TR>
					<TR>
						<TD width="150px"><em>Beltegoed</em></TD><TD></TD><TD></TD>
					</TR>
				</TABLE><br>
		</li>
		<li>
	...
	<ol>
		<li>
			...
			<TABLE FRAME="void" RULES="all"  width="500px" style= "text-align: center">
					...
					<TR>
						<TD width="150px"><em>aantal blokjes</em></TD><TD>1</TD><TD>4</TD><TD></TD><TD></TD><TD></TD><TD></TD>
					</TR>
				</TABLE>
			</li>
			<li>
			...
			<li>
				...
				<em>b</em> = startgetal + hellingsgetal × <em>n</em>? Waarom wel/niet?
			</li>
			<li>
				In de tabel hieronder kijken we naar het verschil tussen de verschillen. 
				Dit noemen we het <b>tweede</b> verschil.<br>
				<br>
...
<!--theorie -->
	<div class="tekstblok theorie analyse">
		...
		<tfoot>
			...
			<em>aantal blokjes</em> = <b>startgetal</b>+ <b>hellingsgetal</b> × <em>nummer figuur</em>
