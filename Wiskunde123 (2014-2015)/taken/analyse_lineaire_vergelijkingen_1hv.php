<title>Leerjaar 1 | Lineaire vergelijkingen (hv)</title>
...
<div class="tekstblok theorie analyse">
	<h3>Inleiding</h3>
	<p>
		In deze taak ga je verder met <b>lineaire verbanden</b>. De grafiek van een lineair verband is altijd een rechte lijn. In de tabel bij een lineair verband is er sprake van regelmaat in de invoer en uitvoer rij. 
	</p>
</div>
...
<!-- opdracht 1-->
		<div class="tekstblok opdracht">
			...
			log in en open de module 'A5 Lineaire Vergelijkingen'. Maak activiteit 1: Lineaire formules.</p>
		</div>

<!--theorie 2-->
	<div class="tekstblok theorie analyse">
		<h3>Lineaire formules</h3>
		<p>De grafiek van <math><mi>y = 3x + 5</mi></math> is een rechte lijn. De formule noemen we een <FONT color="red">lineaire formule</FONT>. Je zegt ook wel er is een <FONT color="red">lineair verband</FONT> tussen <math><mi>x</mi></math> en <math><mi>y</mi></math>.</p>
		<p>Je kan een lijn tekenen als je twee punten weet waar de lijn door heen gaat.</p>
		<p>De algemene vorm van een lijn is <math><mi>y = ax + b</mi></math></p>
		<p>De grafiek van de formule <math><mi>y = ax + b</mi></math> heeft de volgende eigenschappen:<br>
			<ol id="numbers">
				<li>Als je 1 naar rechts gaat, ga je <em>a</em> omhoog.</li>
				<li>De lijn snijdt de <em>y</em>-as in het punt (0,<em>b</em>)</li>
		<!--evenwijdig en zelfde startgetal-->
	</div>
			...
			<ol>
				<li>Teken de grafiek van de volgende formule. 
						<math displaystyle="true">
							...
							<mi>t</mi><mo>+</mo><mn>5</mn></mi>
						</math>
						<br>
				Gebruik daarbij de volgende tabel:<TABLE FRAME="void" RULES="all"  width="200px" style="text-align: center">
									<TR><TD ><em>t</em></TD><TD>0</TD><TD>4</TD></TR>
									<TR><TD><em>N</em></TD><TD></TD><TD></TD></TR></TABLE> </li>
				<li>Teken de grafiek van de volgende formule. 
					<math>
						<mi>y</mi><mo>=</mo><mn>-2</mn><mi>t</mi><mo>+</mo><mn>3</mn>
					</math>
					<br>
				Gebruik daarbij de volgende tabel:<TABLE FRAME="void" RULES="all"  width="200px" style="text-align: center">
									<TR><TD ><em>t</em></TD><TD>0</TD><TD>5</TD></TR>
									<TR><TD><em>y</em></TD><TD></TD><TD></TD></TR></TABLE> </li>
		</div>
