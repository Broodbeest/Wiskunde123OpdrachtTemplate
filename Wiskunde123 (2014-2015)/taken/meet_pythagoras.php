<title>Leerjaar 2 | Pythagoras</title>
	...
	<li>
		...
		<div id="open_doelen" class="modalDialog">
			<div>
				...
				<h3>Doelen</h3>
				<ol>
					<li>Herhalen van eigenschappen van bijzondere driehoeken;</li>
					<li>Herhalen kwadraten en wortels;</li>
					<li>Stelling van Pythagoras mbv tabel om schuine zijde te berkenen;</li>
					<li>Stelling van Pythagoras om rechthoekszijde te berekenen;</li>
					<li>Havo/Vwo: Stelling van Pythagoras mbv <em>a</em><sup>2</sup> + <em>b</em><sup>2</sup> = <em>c</em><sup>2</sup>;</li>
					<li>Stelling van Pythagoras gebruiken om aan te tonen of een driehoek rechthoekig is;</li>
					<li>Hulplijntje zetten om rechthoekige driehoek te herkennen;</li>
				</ol>
			</div>
		</div>
	</li>
			...
			<div>
				...
				<p>
					...
					<ol>
						...
						<li>Geo-driehoek</li>
						<li>Passer</li>
						<li><a href="afbeeldingen/meet_pythagoras/werkblad_pythagoras.pdf"target="_blank">Werkblad</a></li>
					</ol>
				</p>
			</div>
		</div>
...
<div class="tekstblok opdracht">
	...
	<p>
		...
		<img src="afbeeldingen/meet_pythagoras/speciale_driehoeken_opdr.png" width="500px">
		<ol start="4">
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/rechthoekig_opdr.png" width="250px" class="rightfloat">
		Hiernaast zie je drie rechthoekige driehoeken, ze staan ook op je <a href="afbeeldingen/meet_pythagoras/werkblad_pythagoras.pdf" target="_blank">werkblad</a>.
		<ol>
			<li>
	...
	<div class="hider">
		...
		<div class="antwoord">
			<p>
				<img src="afbeeldingen/meet_pythagoras/rechthoekig_antw.png" width="300px" class="rightfloat">
				<ol>
					<li>
						&ang;<em>C</em> is recht. Maar een rechte hoek is 90&deg;.
					</li>
					<li>
...
<div class="tekstblok theorie meetkunde">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/rechthoekig_th.png" width="250px" class="rightfloat">
		Het is belangrijk om <u>rechthoekige</u> driehoeken te kunnen herkennen en wat de <b>rechthoekszijden</b> en de <b>schuine zijde</b> zijn in die rechthoekige driehoek.
		<ul>
...
<!-- G&R Havo en/of VMBO-t langste of schuine zijde??? -->

<div class="tekstblok opdracht ">
	<h3>Opdracht 3 De schuine zijde is de langste!</h3>	
	<p> 
		<img src="afbeeldingen/meet_pythagoras/rechthoekig_antw.png" width="250px" class="rightfloat">
		De rechthoekige driehoeken uit de vorige opgave staan ook op het <a href="afbeeldingen/meet_pythagoras/werkblad_pythagoras.pdf" target="_blank">werkblad</a>.
		<ol>
	...
	<div class="hider">
		...
		<div class="antwoord">
			<p>
				<img src="afbeeldingen/meet_pythagoras/rechthoekig_passer_antw.png" width="250px" class="rightfloat">
				<ol>
...
<div class="tekstblok opdracht">
	<h3>Opdracht 5 Driehoeken tekenen (Vmbo-t)</h3>
	<p>
		<img src="afbeeldingen/meet_pythagoras/tekenen1_opdr.png" width="50px" class="rightfloat">
		Op het <a href="afbeeldingen/meet_pythagoras/werkblad_pythagoras.pdf" target="_blank">werkblad</a> staat een lijn met daarop de punten <em>A</em> en <em>B</em>.
		<ol>
			<li>
	...
	<div class="hider">
		<div class="showhide"></div>
		<div class="antwoord">
			<img src="afbeeldingen/meet_pythagoras/tekenen1_antw.png" width="150px" class="rightfloat">
			<ol>
...
<div class="tekstblok opdracht">
	<h3>Opdracht 6 Driehoeken tekenen (Vmbo-t/Havo)</h3>
	<p>
		<img src="afbeeldingen/meet_pythagoras/tekenen2_opdr.png" class="rightfloat" width="50px">
		Op het <a href="afbeeldingen/meet_pythagoras/werkblad_pythagoras.pdf" target="_blank">werkblad</a> staat een lijn met daarop punt <em>P</em>.
		<ol>
			<li>
	...
	<div class="hider">
		<div class="showhide"></div>
		<div class="antwoord">
			<img src="afbeeldingen/meet_pythagoras/tekenen2_antw.png" width="200px" class="rightfloat">
			<ol>
				<li>Zie afbeelding hiernaast</li>
...
<div class="tekstblok opdracht">
	...
	<p>
		<div class="tekstballon_theorie">
			<p>
				2<sup>2</sup> type je in op je rekenmachine als: <nobr>2 ^ 2</nobr>
			</p>
		</div>
	</p>
	<p>
...
<!-- div class="tekstblok opdracht">
	...
	<div class="hider">
		...
		<div class="antwoord">
			<p>
				<img src="afbeeldingen/meet_pythagoras/345_pythagoras_antw.png" width="200px" class="rightfloat">
				<ol>
...
<div class="tekstblok theorie meetkunde">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/rechthoekig_th_kleur.png" width="300px" class="rightfloat">
	...
	<p> 
		<img src="afbeeldingen/meet_pythagoras/pythagoras_th.png" width="200px" class="rightfloat">
		<u>Voorbeeld</u>:<br>
	...
	<p>
		<table class="stappenplan">
			<tr>
				<td collspan="4"><u>Uitwerking</u></td>
			</tr>
			<tr>
				<td width="50">Stap 1:</td>
				<td width="150">Maak een tabel zoals hiernaast.</td>
				<td width="10"></td>
				<td width="200">
			...
			<tr>
				<td>Stap 2:</td>
				<td>
					Zet de zijden in de tabel, maar zorg dat de <b><FONT color="#006600">langste zijde</FONT></b> altijd onderaan staat! Zet een vraagteken bij de zijde die je moet berekenen
				</td>
				<td></td>
				<td>
					<table class="pythagoras">
			...
			<tr>
				<td>Stap 3:</td>
				<td>Bereken de kwadraten en tel ze bij elkaar op.</td>
				<td></td>
				<td>
					<table class="pythagoras">
						<thead>
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/345_pythagoras_opdr.png" width="250px" class="rightfloat">
		<ol>
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/pythagoras_int_opdr.png" width="350px"class="rightfloat">
...
<div class="tekstblok theorie meetkunde">
	<h3>Theorie C <em>a</em><sup>2</sup> + <em>b</em><sup>2</sup> = <em>c</em><sup>2</sup> (Havo/Vwo)</h3>
	<p>
		<img src="afbeeldingen/meet_pythagoras/formule1_th.png" width="180px" class="rightfloat">
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/pythagoras_int2_opdr.png" width="300px" class="rightfloat">
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/pythagoras_intdec_opdr.png" width="350px" class="rightfloat">
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/check_rechthoekig_opdr.png" width="350px" class="rightfloat">
...
<div class="tekstblok opdracht">
	...
	<div class="hider">
		...
		<div class="antwoord">
			<p>
				<img src="afbeeldingen/meet_pythagoras/assen1_antw.png" width="250px" class="rightfloat">
				<ol>
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/assen2_opdr.png" width="200px" class="rightfloat">
		Bekijk de afbeelding hiernaast, welke ook op het <a href="afbeeldingen/meet_pythagoras/werkblad_pythagoras.pdf" target="_blank">werkblad</a>.
	</p>
	<p>
		...
		<div class="antwoord">
			<p>
				<ol>
					...
					<img src="afbeeldingen/meet_pythagoras/assen2_antw.png" width="250px" class="rightfloat">
					<li>
						<table class="pythagoras">
							<tr>
								<td>zijde</td><td>kwadraat</td>
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/kz_inl_opdr.png" class="rightfloat" width="250px">
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/formule2_th.png" width="200px" class="rightfloat">
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/omgekeerd1_opdr.png" width="300px" class="rightfloat">
		Bekijk de driehoeken hiernaast.
		<ol>
...
<div class="tekstblok theorie meetkunde">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/formule2_th.png" width="150px" class="rightfloat">
		In plaats van een tabel invullen, kun je ook deze ene regel invullen: <em>a</em><sup>2</sup> + <em>b</em><sup>2</sup> = <em>c</em><sup>2</sup>. Daarin zijn <em>a</em> en <em>b</em> de rechthoekszijden en <em>c</em> de schuine zijde.
	</p>
	<p>
		<u>Voorbeeld</u>:<br>
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/mix_opdr.png" width="250px" class="rightfloat">
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/vlieger_opdr.png" width="300px" class="rightfloat">
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/hoogtelijn_opdr.png" class="rightfloat" width="250px">
...
<div class="tekstblok theorie meetkunde">
	...
	<p>
		...
		<img src="afbeeldingen/meet_pythagoras/hulplijntje_th.png" width="150px" class="rightfloat">
	</p>
	<p>
		<u>Voorbeeld</u>:<br>
	...
	<p>
		...
		<img src="afbeeldingen/meet_pythagoras/hulplijntje_th_uitw.png" width="250px" class="rightfloat">
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/glas_rietje_opdr.png" width="200px" class="rightfloat">
	...
	<div class="hider">
		...
		<div class="antwoord">
			<p>
				<img src="afbeeldingen/meet_pythagoras/glas_rietje_antw.png" width="" class="">
				<ol>
					<li></li>
					<li></li>
				</ol>
...
<div class="tekstblok opdracht">
	...
	<p>
		<img src="afbeeldingen/meet_pythagoras/studentenkamer_opdr.png" class="rightfloat" width="250px">
	...
	<div class="hider">
		...
		<div class="antwoord">
			<p>
				<img src="afbeeldingen/meet_pythagoras/studentenkamer_antw.png" width="250px" class="rightfloat">
				<ol>
					<li>
...
<div class="tekstblok opdracht">
	...
	<p>
		...
		<img src="afbeeldingen/meet_pythagoras/tuin_opdr.png" width="600px"><br>
