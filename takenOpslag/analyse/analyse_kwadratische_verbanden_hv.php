<title >Leerjaar 2 | Kwadratische verbanden (2 havo/vwo)</title>
...
<!--theorie -->
	<div class="tekstblok theorie analyse">
		...
		<p>
		De formule van de korfballer uit opdracht `17` is een voorbeeld van een <b>kwadratische formule</b>.
		...
		<p>
			...
			Als er een <b>positief</b> getal voor de `x`<sup>2</sup> staat dan is het een <b>dal</b>parabool.
		</p>
...
<!--theorie -->
	<div class="tekstblok theorie analyse">
		<h3>Theorie Coördinaten van top van parabool</h3>
		<p>
			...
			<div class="antwoord">
				<ol>
					...
					<li>
						...
						<br>
						Dus coördinaten top: `T(1/2 , -5 1/4)`
					</li>
				</ol>
			</div>		
		</div>
		...
		<p>
			...
			<tbody>
				<tr>
					...
					<td width="150" style="vertical-align: top">Bereken de coördinaten van de top.</td>
...
<!-- opdracht -->
		<div class="tekstblok opdracht">
			...
			<p>
				Marit maakt een werkstuk over volleyballen.
				...
				<br>
				<em>hoogte</em> ` = − 0,05` &sdot; `a` <sup>2</sup> ` + 0,7`&sdot;`a + 0,55`
			</p>
			...
			<p>
				...
				<ol>
					...
					<li>
						...
						<br>
						<TABLE FRAME="void" RULES="all"  width="550px" style= "text-align: center">
						<TR>
		...
		<div class="tekstblok opdracht">
			...
			<p>Hieronder zie je een boogbrug die de vorm heeft van een parabool. De formule die bij de parabool hoort, is 
				...
				<ol>
					...
					<li>
						<img src="afbeeldingen/analyse_kwadratische_verbanden_hv/containerboot.PNG"  class="rightfloat" width="200px" >
...
<!-- opdracht -->
		<div class="tekstblok theorie analyse">
			<h3>Proeftoets</h3>
			<p>
				Voor een proeftoets inclusief uitwerkingen, klik op:	<a href="afbeeldingen/analyse_kwadratische_verbanden_vmbo-t/Kwadratische_verbanden_proeftoets.pdf" alt="Kwadratische_verbanden_proeftoets" target="_blank">Proeftoets</a>.
			<br>
