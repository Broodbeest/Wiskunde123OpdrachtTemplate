<title>	Leerjaar 2 | Kwadratische verbanden</title>
...
<div class="bodytekst">
	...
	<!-- Hoofdtitel pagina -->
	<h1>Analyse  Kwadratische verbanden</h1>
<div class="tekstblok theorie analyse">
			<h3>Inhoud</h3>
			In de vorige analyse blokken hebben jullie alles geleerd over lineaire formules.
			In deze taak leer je wat kwadratische formules zijn en hoe de grafiek van een kwadratisch verband er uit ziet. 
...
<div class="tekstblok theorie analyse">
			<h3>Inhoud</h3>
			<p>
				Voorkennis: kwadraten en wortels en machten<br>
				zelfde taak als analyse 6t
			</p>
			<p>
				zie ook taak vmbo-t voor inhoud
			</p>
...
<div class="tekstblok opdracht analyse">
	<h3>Opdracht 1</h3>
		<img src="../afbeeldingen/analyse_kwadratische_verbanden_vmbo-t/blokjes_1.png" alt="blokjes_1" width="600" height="" />
	<ol>
		<li>
			...
			<TABLE FRAME="void" RULES="all"  width="500px" style= "text-align: center">
					...
					<TR>
						<TD width="150px"><em>aantal blokjes</em></TD><TD>3</TD><TD>5</TD><TD></TD><TD></TD><TD></TD><TD></TD><TD></TD>
					</TR>
				</TABLE>
			</li>
			<li>
				Hoeveel blokjes komen er elke keer bij? Dit is het hellingsgetal in de formule. Geef dit met pijlen aan in de tabel.
			</li>
			<li>
				Hoeveel blokjes heeft figuur nummer `0`? Dit is het startgetal in de formule. <br>
			</li>
			<li>
			...
			<li>
				Neem de formule over en vul op de plek van startgetal en hellingsgetal de getallen hierboven in.<br>
				<em>aantal blokjes</em> = startgetal + hellingsgetal × <em>nummer figuur</em>
			<p>
				Vanaf nu zullen we de woorden in de formules <b>afkorten</b> met een <b>letter</b>. Meestal nemen we hiervoor de eerste letter van het woord. Dus blokjes korten we af met de letter <em>b</em> 
				en nummer figuur korten we af met de letter <em>n</em>.
			</p>
			...
			<div class="antwoord">
				<h3>Antwoorden bij opdracht 1</h3>
					<ol>
						...
						<li><br>
							<img src="afbeeldingen/analyse_kwadratische_verbanden_hv/antwoord_opdracht_1g"   width="300px">
						</li>
...
<div class="tekstblok opdracht">
	<h3>Opdracht 2</h3>
	<p><img src="afbeeldingen/analyse_kwadratische_verbanden_vmbo-t/abonnement"  class="rightfloat" width="300" />
		Voor een telefoonabonnement betaal je abonnementskosten en belkosten. 
		Stel je voor je betaalt € `10,00` abonnementskosten per maand en nog € `0,20` per minuut.
		Van de kosten per maand kun je een woordformule maken.
	</p>
	<ol>
		<li>
		...
		<li>
			...
			<TABLE FRAME="void" RULES="all"  width="500px" style= "text-align: center">
					<TR>
						<TD width="150px"><em>a</em></TD><TD>0</TD><TD>50</TD>
					</TR>
					<TR>
						<TD width="150px"><em>K</em></TD><TD></TD><TD></TD>
					</TR>
				</TABLE><br>
		</li>
		<li>
			Teken de grafiek van <em>K</em>. Gebruik daarvoor de tabel.
		</li>
		<!--VMBO-T
		<li>
		...
		<li><aside class="tekstballon_theorie">
			<p>Kijk eens terug naar opdracht 5 in de taak <a href="index2.php?p=analyse_lineaire_vergelijkingen_2hv" target="_blank">lineaire vergelijkingen</a> 
				voor een herhaling van vergelijkingen.</p>
			</aside>
			In december krijg Femke een rekening van <br> €`15,35` euro.
			Stel de vergelijking op waarmee Femke kan berekenen hoeveel minuten ze gebeld heeft in december.
		</li>
		<li>
			Los de vergelijking op. Hoeveel  heeft Femke gebeld in december? Geef je antwoord in <b>seconden</b> nauwkeurig.
...
<div class="hider">
		...
		<li>
			<em>Kosten</em>`=10+0,20*`<em>aantal minuten</em>
		</li>
		<li>
			<TABLE FRAME="void" RULES="all"  width="500px" style= "text-align: center">
					<TR>
						<TD width="150px"><em>aantal minuten</em></TD><TD>0</TD><TD>50</TD>
					</TR>
					<TR>
						<TD width="150px"><em>Kosten</em></TD><TD>10</TD><TD>20</TD>
					</TR>
				</TABLE><br>
		</li>
		<li><br>
		...
		<li>
			<table>
					...
					<tr>
						<td class="tussenstap_vergelijking">`:0,20`</td>
						<td></td>
						<td class="tussenstap_vergelijking">`:0,20`</td>
					</tr>
					<tr>
						...
						Dus Femke heeft `26` minuten en `0,75*60=45` seconden gebeld.
				</li>
</div>
...
<div class="tekstblok opdracht">
	<h3>Opdracht 3</h3>
	<p>
		Een andere manier om te bellen is via een pre-paid abonnement. Je koopt vooraf een beltegoed.
		De kosten voor het aantal minuten dat je hebt gebeld gaat van je beltegoed af. 
		De formule waarmee je jouw beltegoed kan berekenen is:<br>
		<em>B</em> `= 40 - 0,25 * `a.
	</p>
	<ol>
		<li>
...
<div class="tekstblok opdracht analyse">
	<h3>Opdracht 4</h3>
		<img src="afbeeldingen/analyse_kwadratische_verbanden_vmbo-t/blokjes_2.PNG" alt="blokjes_2" width="400" height="" />
	<ol>
		<li>
			Neem de tabel over en vul hem verder in.
			<TABLE FRAME="void" RULES="all"  width="500px" style= "text-align: center">
					...
					<TR>
						<TD width="150px"><em>a</em></TD><TD>1</TD><TD>4</TD><TD></TD><TD></TD><TD></TD><TD></TD>
					</TR>
				</TABLE>
			</li>
			<li>
			...
			<li>
				Kan je bij de tabel een formule maken van de vorm:<br>
				<em>a</em> = startgetal + hellingsgetal × <em>n</em>? Waarom wel/niet?
			</li>
			<li>
		...
		<tfoot>
			...
			<li>
				Welke woordformule past bij de rij?<br>
				<ol id="numbers">
					<li><aside class="tekstballon_theorie">
					<p>Weet je nog:<br>
						`n`<sup>2</sup> `= n * n`.<br>
						Kijk terug in de taak <a href="index2.php?p=vaar_machten_en_wortels_2thv" target="_blank">machten en wortels</a> 
						voor een herhaling van kwadraat.</p>
					</aside>
						a `= n`<sup>2</sup>
					</li>
					<li>
			...
			<li>
				Bereken met de formule het <em>aantal blokjes</em> als <nobr><em>n</em> `= 10`</nobr>.  (Dus bereken het aantal blokjes van figuur met nummer `10`.)
			</li>
		</ol>
			...
			<div class="antwoord">
					<ol>
						<li>
							<TABLE FRAME="void" RULES="all"  width="500px" style="text-align: center">
									<TR>
										<TD width="150"><em>nummer figuur</em></TD><TD>1</TD><TD>2</TD><TD>3</TD><TD>4</TD><TD>5</TD><TD>6</TD>
									</TR>
									<TR>
										<TD width="150"><em>aantal blokjes</em></TD><TD>1</TD><TD>4</TD><TD>9</TD><TD>16</TD><TD>25</TD><TD>36</TD>
									</TR>
							</TABLE>
						</li>
						<li>
						...
						<li>
							Nee, want de verschillen zijn niet steeds hetzelfde.
						</li>
						<li>
								<table class="verhouding" style="background-color:white">
		...
		<tfoot>
			<tr >
				...
				<th></th>
						...
						<li>
							<em>Aantal blokjes</em>`=10^2`<br>
							<em>Aantal blokjes</em>`=100`
						</li>
					</ol>
			</div>
		</div>
...
<!--theorie -->
	<div class="tekstblok theorie analyse">
		...
		<p>
			In de eerste drie opgaven is de toename, dit noemen we het eerste verschil, steeds hetzelfde:
			<br>
			<table class="verhouding" >
		...
		<tfoot>
			...
			<em>a</em> = <b>startgetal</b>+ <b>hellingsgetal</b> × <em>n</em><br>
			...
			Bij de tabellen van opdracht `4` en `5` is het <b>tweede</b> verschil steeds hetzelfde:
			<br>
			<table class="verhouding" >
		...
		<tfoot>
			...
			Bij zo'n tabel hoort een <b>kwadratische formule</b>.<br>
			<br>
			Het aantal blokjes in opdracht `4` kun je berekenen met de formule:<br>
			<em>a</em> `= n`<sup>2</sup><br>
			<br>
	</div>
...
<!--theorie -->
	<div class="tekstblok theorie analyse">
		<h3>Formules met kwadraten</h3>
			<p>Bij tabel `4` in opgave `9` hoort een <b>kwadratische formule</b>:
			<br>
...
<!-- opdracht -->
		<div class="tekstblok opdracht">
			...
			<p>Hafid wil graag weten hoe zwaar hij mag zijn om nog een gezond gewicht te hebben.
				...
				De <em>lengte</em> is in meters en het <em>lichaamsgewicht</em> in kg.</p>
				<ol>
					<li>
			...
			<p><img src="afbeeldingen/analyse_kwadratische_verbanden_vmbo-t/opdracht_bal.png"  width="250px" class="rightfloat">
				...
				<ol>
					...
					<li>
						...
						<TABLE FRAME="void" RULES="all"  width="500px" style= "text-align: center">
						<TR>
							<TD width="150px"><em>afstand in meters</em></TD><TD>0</TD><TD>1</TD><TD>2</TD><TD>3</TD>4<TD>5</TD><TD>6</TD><TD>7</TD><TD>8</TD>
						</TR>
						<TR>
...
<!-- opdracht -->
		<div class="tekstblok opdracht">
			...
			<p><img src="afbeeldingen/analyse_kwadratische_verbanden_vmbo-t/opdracht_basketbal_kleur.png"  width="300px" class="rightfloat">
				...
				Hierin is de <em>H</em> de hoogte in meters en `a` de afstand in meters.</p>
				<ol>
					<li>
...
<!--theorie -->
	<div class="tekstblok theorie analyse">
		<h3>Formule kwadratisch verband</h3>
		De formule van de korfballer uit opdracht `17` is een voorbeeld van een <em>kwadratische formule</em>.
		Een kwadratische formule is altijd van de vorm:<br>
		`y=ax`<sup>2</sup>`+bx+c` waarbij `a!=0`<br>
		`a` is het getal <b>voor</b> `x`<sup>2</sup><br>
		`b` is het getal <b>voor</b> `x`<br>
		`c` is het losse getal.<br>
		<br>
		De formule uit opdracht `17` is:<br>
		<em>H</em> `= -0,56a`<sup>`2`</sup> `+ 3a + 2`.<br>
		...
		`c = 2`<br>
		<br>
		Je kan aan het getal voor de `x`<sup>2</sup> zien of het een bergparabool of een dalparabool is.<br>
		Als er een <b>negatief</b> getal voor de `x`<sup>2</sup> staat dan is het een <b>berg</b>parabool.<br>
		Als er een <b>positief</b> getal voor de `x`<sup>2</sup> staat dan is het een <b>dal</b>parabool.<br>
		<img src="afbeeldingen/analyse_kwadratische_verbanden_hv/bergparabool.png"  width="250px" class="rightfloat">
		<img src="afbeeldingen/analyse_kwadratische_verbanden_hv/dalparabool.png"  width="250px" class="leftfloat">
	</div>
...
<div class="hider">
			...
			<div class="antwoord">
				<ol>
					...
					<li><aside class="tekstballon_theorie">
						Let op: de `a` is het getal voor `x^2` en hoeft niet altijd vooraan te staan!
						</aside>
						`a= 4`<br>
						`b= 2`<br>
						`c= -10`<br>
...
<!--theorie -->
	<div class="tekstblok theorie analyse">
		<h3>Bereken coordinaten van de top van de parabool</h3>
		De `x`-coordinaat van de top van de parabool bereken je met de formule:<br>
		`x`<sub>top</sub>`= - (b)/(2a)`<br>
		De `y`-coordinaat bereken je door de `x`-coordinaat in te vullen in de formule.<br>
		<br>
		Voorbeeld:
		Bereken de top van de parabool `y=4x`<sup>2</sup>`+40x + 5`<br>
		`a = 4`<br>
		`b = 40`<br>
		<br>
		`x`<sub>top</sub>`= - (b)/(2a)`<br>
		<br>
		`x`<sub>top</sub>`= - (40)/(2*4)`<br>
		<br>
		`x`<sub>top</sub>`= -(40)/(8)`<br>
		`x`<sub>top</sub>`= -5`<br>
		<br>
		`y`<sub>top</sub>`=4*(-5)`<sup>2</sup>`+40*-5 + 5`<br>
		`y`<sub>top</sub>`=4*25 + -200 + 5`<br>
		`y`<sub>top</sub>`=100 - 200 + 5`<br>
		`y`<sub>top</sub>`=-100+5 = -95`<br>
		<br>
		Dus coordinaten top: `T(-5,95)`
	</div>
			...
			<div class="antwoord">
				<ol>
					...
					<li>
						...
						`y`<sub>top</sub>`=4*(-3)^2 + 18*-3-4`<br>
						`y`<sub>top</sub>`=4*9 + 18*-3 -4`<br>
						`y`<sub>top</sub>`=36 + -54 -4`<br>
						`y`<sub>top</sub>`=36 + -54 -4 = -22`<br>
						<br>
						Dus coordinaten top: `T(-3,22)`
					</li>
				</ol>
			...
			<div class="antwoord">
				<ol>
					...
					<li>
						...
						`y`<sub>top</sub>`=-2 + 4*2 +5`<br>
						`y`<sub>top</sub>`=-2 + 8 +5 = 11`<br>
						<br>
						Dus coordinaten top: `T(2,11)`
					</li>
				</ol>
			</div>		
		</div>
			...
			<div class="antwoord">
				<ol>
					...
					<li>
						...
						<br>
						Dus coordinaten top: `T(1/2 , -5 1/4)`
					</li>
				</ol>
			</div>		
		</div>
		...
		<p>
			...
			<tbody>
				<tr>
					...
					<td width="150" style="vertical-align: top">Bereken de coordinaten van de top.</td>
					<td width="100" style="vertical-align: top">
						...
						`x`<sub>top</sub>`= - (b)/(2a)`<br>
						<br>
						`x`<sub>top</sub>`= - (-12)/(2*2)`<br>
						<br>
						`x`<sub>top</sub>`= -(-12)/(4)`<br>
						`x`<sub>top</sub>`= 3`<br>
						<br>
						`y=2x^2-12x+20`<br>
						`y`<sub>top</sub>`=2*3`<sup>2</sup>`-12*3 + 20`<br>
						`y`<sub>top</sub>`=2*9 - 36 + 20`<br>
						`y`<sub>top</sub>`=18 - 36 + 20`<br>
						`y`<sub>top</sub>`=-18 + 20 = 2`<br>
						<br>
						Dus coordinaten top: `T(3,2)`
					</td>
				</tr>
				<tr>
					<td width="60" style="vertical-align: top">Stap 2</td>
					<td width="150" style="vertical-align: top">Maak een tabel. Zet de top in het midden van de tabel. Kies aan beide kanten nog 3 getallen voor `x`</td>
					<td width="100">
						<TABLE FRAME="void" RULES="all"  width="200px" style= "text-align: center">
						<TR>
							<TD width="25px"><em>`x`</em></TD><TD width="50px">0</TD><TD width="50px">1</TD><TD width="50px">2</TD><TD width="50px">3</TD><TD width="50px">4</TD><TD width="50px">5</TD><TD width="50px">6</TD>
						</TR>
						<TR>
							<TD width="25px"><em>y</em></TD><TD width="50px">20</TD><TD width="50px">10</TD><TD width="50px">4</TD><TD width="50px">2</TD><TD width="50px">4</TD><TD width="50px">10</TD><TD width="50px">20</TD>						
						</TR>
						</TABLE><br>
					</td>
				</tr>	
				<tr>
					...
					<td> <img src="afbeeldingen/analyse_kwadratische_verbanden_hv/theorie_grafiek_tekenen_1.png"  width="225px" ></td>

				</tr>
				<tr>
					<td width="60" style="vertical-align: top">Stap 3</td>
					<td width="150" style="vertical-align: top">Teken de punten uit de tabel in het assenstelsel.</td>
					<td><img src="afbeeldingen/analyse_kwadratische_verbanden_hv/theorie_grafiek_tekenen_2.png"  width="225px" ></td>
				</tr>
				<tr>
					...
					<td><img src="afbeeldingen/analyse_kwadratische_verbanden_hv/theorie_grafiek_tekenen_3.png"  width="225px" ></td>
				</tr>
				<tr>
					<td width="60" style="vertical-align: top">Stap 5</td>
					<td width="150" style="vertical-align: top">Zet de formule bij de grafiek.</td>
					<td><img src="afbeeldingen/analyse_kwadratische_verbanden_hv/theorie_grafiek_tekenen_4.png"  width="225px" ></td>
				</tr>
				</tbody>
				</table>
			</p>
