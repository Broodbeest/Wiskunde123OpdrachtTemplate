...
<title>Leerjaar 2hv | <?php echo $taaknaam; ?></title>
...
<div class="taakinhoud"><!-- de taak zelf -->
	...
	<div class="tekstblok opdracht">
		<h3>Opdracht 6 Driehoeken tekenen</h3>
		<div class="row">
			<div class="col-xs-10">
				<p>
	...
	<div class="tekstblok opdracht">
		<h3>Opdracht 7 Driehoeken tekenen</h3>
		<p>
			<ol>
				<li>
	...
	<div class="tekstblok opdracht">
		<h3>Opdracht 8 Driehoeken tekenen</h3>
		<p>
			<ol>
				<li>
		...
		<div class="row">
			<div class="col-xs-6">
				<p>
					...
					De zijde die <b>niet</b> aan de rechte hoek vast zit heet de <b><font color="#006600">schuine zijde</font></b>, maar wordt ook wel <b><font color="#006600">lange zijde</font></b> of <b><font color="#006600">hypothenusa</font></b> genoemd. De schuine zijde bevindt zich altijd tegenover de rechte hoek.<br>
				</p> 
			</div>
			<div class="col-xs-6">
	...
	<div class="tekstblok opdracht">
		...
		<div class="hider">
			...
			<div class="antwoord">
				<p>
					<ol>
						<li>Omdat dat de schuine / langste zijde is</li>
	...
	<div class="tekstblok theorie meetkunde" id="theorieC">
		<h3>Theorie C De formule <em>a</em><sup>2</sup> + <em>b</em><sup>2</sup> = <em>c</em><sup>2</sup></h3>
		<p>
					...
					<table class="stappenplan">
						<tr>
							...
							<td>
								...
								4<sup>2</sup> + 4,2<sup>2</sup> = <em>AC</em><sup>2</sup>
							</td>
						</tr>
						<tr>
							<td>Stap 2</td>
							...
							<td>
								4<sup>2</sup> + 4,2<sup>2</sup> = <em>AC</em><sup>2</sup><br>
						...
						<tr>
							...
							<td>16 + 17,64 = 33,64<br>
								Dus <em>AC</em><sup>2</sup> = 33,64</td>
						</tr>
						<tr>
							<td>Stap 4</td>
							<td>Neem de wortel</td>
							<td><em>AC</em> = `sqrt(33,64)=5,8`</td>
						</tr>
					</table>
				</p>
			</div>
			...
			<div class="antwoord">
				<p>
					<ol>
						...
						<li><em>BC</em><sup>2</sup> = 33,64 - 16 = 17,64</li>
						<li><em>BC</em> = `sqrt17,64=4,2`</li>
					</ol>
					<table class="pythagoras">
						<tr>
							<td>zijde</td><td>kwadraat</td><td></td>
						...
						<tr>
							<td><em>AC</em> = 5,8</td><td>33,64</td><td></td>
						</tr>
					</table>
				</p>
			</div>
