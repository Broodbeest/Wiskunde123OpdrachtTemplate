...
<div class="tekstblok opdracht" id="4">
	...
	<ol>
		...
		<li>Hoeveel stoelen heb je nodig voor het 6<sup>e</sup> figuur? </li>
		<li>En hoeveel stoelen voor het 10<sup>e</sup> figuur?</li>
		<li>Hoe bereken je het aantal stoelen als je het nummer van het figuur weet?</li>
		<li>
			Neem over en vul in.<br>
		...
		<div class="antwoord">
			<ol>
				...
				<li>
					...
					Het vierde figuur had al negen stoelen, daar komen 2 keer 2 stoelen bij.<br>
				...
				<li>
					Manier 1: doortellen<br>
					Het 6<sup>e</sup> figuur had al 13 stoelen, daar komen 4 keer 2 stoelen bij.<br>
				...
				<li>
					In het eerste figuur heb je 2 stoelen aan de zijkanten en 1 aan kop. Bij het volgende figuur, dus als er een tafel bij komt, 
...
<div class="tekstblok opdracht" id="8">
	...
	<img src="afbeeldingen/analyse_leerjaar_1/tafelschikkingen_2.png" width="600" />
		<ol>
			<li>Teken figuur 4.</li>
			<li>Hoeveel stoelen heb je nodig voor het 5<sup>e</sup> figuur?</li>
			<li>
...
<div class="tekstblok opdracht" id="10">
	...
	<p>
		We zouden ook nog een figuur <b>vóór</b> figuur nummer 1 kunnen leggen. Dit figuur noemen we dan <b>figuur nummer 0</b>.
	</p>
	<br>
	<ol start="3">
		<li>
...
<div class="tekstblok opdracht" id="18">
	...
	<p>
		<ol>
			...
			<li>
				Bereken de coördinaten van het hoogste punt van het 63<sup>e</sup> figuur.
			</li>
		</ol>
		<div class="hider">
			<div class="showhide">&rarr;</div>
